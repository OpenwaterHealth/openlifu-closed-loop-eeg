# This file is vendored from Openwater's SlicerOpenLIFU extension and MODIFIED for the
# closed-loop EEG-triggered LIFU experiment in this repository (openlifu-closed-loop-eeg):
# a TCP remote-run listener that src/openlifu_closed_loop/main_pipeline.py drives,
# hardware-trigger call retries, and an absolute_theta_value safety check. See
# ../README.md for details and where this diverges from upstream.
#
# Licensed under AGPL-3.0 (see ../LICENSE), separate from this repository's own
