"""
Quantifies the latency between the software LIFU_ON marker and the actual
physical trigger artifact in the EEG -- not just a visual scope check.
(Based on the approach in notebooks/latency.ipynb, adapted here to read from
an .xdf fixture instead of loose CSV files.)
